...
<head>
    ...
    <link rel="stylesheet" href="{{url('assets/admin/assets/vendor/pnotify/pnotify.custom.css')}}" />

    <!-- Admin Extension CSS -->
    <link rel="stylesheet" href="{{url('assets/admin/assets/stylesheets/theme-admin-extension.css')}}">

    <!-- Admin Extension Skin CSS -->
    <link rel="stylesheet" href="{{url('assets/admin/assets/stylesheets/skins/extension.css')}}">
    <!-- Current Page CSS -->
