                        ...
                        <div class="col-sm-12">
                            <div class="featured-box featured-box-primary align-left mt-xlg">
                                <div class="box-content">
                                    <h4 class="heading-primary text-center text-uppercase mb-md">Register A Student</h4>
                                    <section class="panel form-wizard" id="w3">
                                        <div class="panel-body">
                                            <div class="wizard-progress">
                                                ...
                                                <ul>
                                                    <li class="active">
                                                        <a href="#w3-account" data-toggle="tab"><span>1</span>Student Details</a>
                                                    </li>
                                                    <li>
                                                        <a href="#w3-profile" data-toggle="tab"><span>2</span>Student Address</a>
                                                    </li>
                                                    <li>
                                            ...
                                            <div class="tab-content">
                                                <div id="w3-account" class="tab-pane active" style="margin-bottom: 100px;">
                                                    <div class="col-md-4">
                                                        {{Form::label('student_name',"NAME",array('class'=>'control-label ','for'=>'w3-studentname'))}}
                                                        <div class="form-group input-group">
                                                            <span class="input-group-addon btn-default"><i class="fa fa-institution"></i> </span>
                                                            {{Form::text('student_name',null,array('placeholder'=>'E.g. John Doe','class'=>'form-control','id'=>'w3-insttitutename','required','minlength'=>10))}}
