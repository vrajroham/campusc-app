													...
													<li class="dropdown active">
														...
														<ul class="dropdown-menu">
															...
															<li class="dropdown-submenu">
																...
																<ul class="dropdown-menu">
																	<li><a href="index-classic.html" data-thumb-preview="{{url('assets')}}/img/previews/preview-classic.jpg">Classic - Original</a></li>
				...
				<div class="container">
					...
					<div class="row center">
						<div class="owl-carousel owl-theme" data-plugin-options='{"items": 6, "autoplay": true, "autoplayTimeout": 3000}'>
							<div>
								<img class="img-responsive" src="{{url('assets')}}/img/logos/logo-1.png" alt="">
							</div>
							<div>
								<img class="img-responsive" src="{{url('assets')}}/img/logos/logo-2.png" alt="">
							</div>
							<div>
								<img class="img-responsive" src="{{url('assets')}}/img/logos/logo-3.png" alt="">
							</div>
							<div>
								<img class="img-responsive" src="{{url('assets')}}/img/logos/logo-4.png" alt="">
							</div>
							<div>
								<img class="img-responsive" src="{{url('assets')}}/img/logos/logo-5.png" alt="">
							</div>
							<div>
								<img class="img-responsive" src="{{url('assets')}}/img/logos/logo-6.png" alt="">
							</div>
							<div>
								<img class="img-responsive" src="{{url('assets')}}/img/logos/logo-4.png" alt="">
							</div>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="newsletter">
								...
								<form id="newsletterForm" action="{{url('assets')}}/php/newsletter-subscribe.php" method="POST">
									<div class="input-group">
